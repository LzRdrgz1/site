            ...
            $html->element("div", array("class" => "panel-body"), array(
                $html->element("div", array("class" => "row"), array(
                    ...
                    $html->element("div", array("class" => "col-md-3"), array(
                        ...
                        $html->element("div", array("class" => "weekly-summary text-right"), array(
                            $html->element("span", array("class" => "number", "id" => "license_status"), array(
                            ...
                            $html->element("span", array("class" => "info-label"), array("License Key Status")),
                        )),
                        $html->element("div", array("class" => "weekly-summary text-right truncate"), array(
                            $html->element("span", array("class" => "number", "id" => "license_domain"), array(
                                $html->element("div", array("class" => "wave"), array(
                                    $html->element("span", array("class" => "dot"), false),
                                    $html->element("span", array("class" => "dot"), false),
                                    $html->element("span", array("class" => "dot"), false),
                            ...
                            $html->element("span", array("class" => "info-label"), array("Licensed Domain")),
                        )),
                    )),
                )),
            )),
                ...
                $html->element("table", array("class" => "table table-striped no-margins top-table"), array(
                    $html->element("tbody", false, array(
                        $html->element("tr", false, array(
                            $html->element("td", false, array("Product Name")),
                            $html->element("td", false, array(
                                $html->element("a", array(
                                    "href"  => "https://juicycodes.com/products/google-drive-proxy-player-script/",
                                    "class" => "pull-right",
                                ), array(
                        ...
                        $html->element("tr", false, array(
                            $html->element("td", false, array("Product License")),
                            $html->element("td", false, array($html->element("span", array("class" => "pull-right"), array(Data::Get("license"))))),
                        )),
                        $html->element("tr", false, array(
                            $html->element("td", false, array("Installed Version")),
                            $html->element("td", false, array($html->element("span", array("class" => "badge pull-right"), array(
                                App::Version(),
                            )))),
                        )),
                        $html->element("tr", false, array(
                            $html->element("td", false, array("Latest Version")),
                            $html->element("td", false, array(
                                $html->element("span", array("class" => "badge pull-right", "id" => "latest_version"), array(
                                    $html->element("div", array("class" => "wave"), array(
                                        $html->element("span", array("class" => "dot"), false),
                                        $html->element("span", array("class" => "dot"), false),
                                        $html->element("span", array("class" => "dot"), false),
                        ...
                        $html->element("tr", false, array(
                            $html->element("td", false, array("Update Subscription")),
                            $html->element("td", false, array(
                                $html->element("span", array("class" => "badge pull-right", "id" => "update_subscription"), array(
                                    $html->element("div", array("class" => "wave"), array(
                                        $html->element("span", array("class" => "dot"), false),
                                        $html->element("span", array("class" => "dot"), false),
                                        $html->element("span", array("class" => "dot"), false),
