        ...
        $html->element("div", array("class" => "panel-body"), array(
            $html->element("div", array("class" => "row"), array(
                ...
                $html->element("div", array("class" => "col-lg-4 col-md-6"), array(
                    ...
                    $html->element("div", array("class" => "form-group"), array(
                        $html->label("cdn_url", "control-label", "Load Balacers"),
                        $html->tip("Comma separated load balancer urls"),
                        $html->input("text", "form-control", "url", "cdn_url", Data::Get("cdn_url"), "Comma separated load balancer urls"),
                    )),
                )),
            )),
        )),
